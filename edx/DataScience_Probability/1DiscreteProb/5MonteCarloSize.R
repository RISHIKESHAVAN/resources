...
## Determining the correct number of B can require advanced statistics.
...
## using several B values and plots the results. 
## When B is large enough that the estimated probability stays stable, 
## then we have selected a useful value of B.
